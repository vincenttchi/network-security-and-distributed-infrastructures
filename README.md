...
### Distributed Infrastructure Track (CECS 327)
...
- **[anycast-multicast-protocols](./distributed-infrastructure-cecs327/anycast-multicast-protocols/)**
...
- **[dht-decentralized-storage](./distributed-infrastructure-cecs327/dht-decentralized-storage/)**
...
- **[p2p-bootstrap-network](./distributed-infrastructure-cecs327/p2p-bootstrap-network/)**
  - _Objective:_ Construct a decentralized peer-to-peer network matrix executing a Chord Distributed Hash Table (DHT) framework with **SHA-1 hashing** for deterministic data routing and multi-node gossip cluster synchronization.

### Network Security Operations Track (CECS 303)
...
- **[active-recon-nmap](./network-security-ops-cecs303/active-recon-nmap/)**
...
- **[perimeter-firewall-iptables](./network-security-ops-cecs303/perimeter-firewall-iptables/)**
...
- **[system-call-auditing-strace](./network-security-ops-cecs303/system-call-auditing-strace/)**
...
- **Distributed Architectures:** Peer-to-Peer Chord Routing Algorithms, SHA-1 Cryptographic Token Tokenization, TCP/IP Stack Socket Implementation, Cluster Synchronization.
